...
class TopicListScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTopicItem('Early Settlements in Bengal', 'Completed • 12/12 Lessons', Icons.check_circle, Colors.green, isCompleted: true),
            _buildTopicItem('The Pala Dynasty', '6/10 lessons', Icons.book, AppColors.primary, isCurrent: true, progress: 0.6),
            _buildTopicItem('The Sultans of Bengal', 'Not Started • 15 Lessons', Icons.lock, Colors.grey, isLocked: true),
            _buildTopicItem('The Mughal Period', 'Not Started • 22 Lessons', Icons.explore, Colors.grey, isLocked: true),
            _buildTopicItem('Medieval Architecture', 'Not Started • 8 Lessons', Icons.architecture, Colors.grey, isLocked: true),
          ],
        ),
      ),
    );
  ...
  Widget _buildTopicItem(String title, String subtitle, IconData icon, Color color, {bool isCompleted = false, bool isCurrent = false, bool isLocked = false, double progress = 0.0}) {
    return Container(
