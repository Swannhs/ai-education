...
class SubjectDetailScreen extends ConsumerWidget {
  ...
  const SubjectDetailScreen({super.key, this.subjectId = '1'});
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildCourseContent(context, chapters),
  ...
  Widget _buildCourseContent(BuildContext context, List<Chapter> chapters) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Course Content', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 16),
        ...chapters.map((chapter) => _buildChapterItem(context, chapter)),
      ],
    );
  }
  ...
  Widget _buildChapterItem(BuildContext context, Chapter chapter) {
    return ListTile(
      onTap: () {
        Navigator.pushNamed(context, AppRouter.topicList, arguments: chapter.id);
      },
      ...
      subtitle: Text(chapter.description, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 12, color: AppColors.textSecondary)),
